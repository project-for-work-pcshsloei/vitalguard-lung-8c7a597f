...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DNmExxbN.js");
...
const manifest = {
  "c6e7131ee654e8291980c17a496f1dba90e37f55b10d5f98911cc890905b8604": {
    functionName: "analyzeRisk_createServerFn_handler",
    importer: () => import("./ai.functions-C0IKDqn2.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BIuzH-dV.js").then((n) => n.r),
    import("./start-Bm1gMdY-.js"),
